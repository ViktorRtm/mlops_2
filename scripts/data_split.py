...
out_train_y_path = os.path.join('data', 'stage4', 'train_y.csv')
out_val_x_path = os.path.join('data', 'stage4', 'val_x.csv')
out_val_y_path = os.path.join('data', 'stage4', 'val_y.csv')
